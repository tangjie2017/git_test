...
@section('content')
    ...
    <div class="titile">
        ...
        <div class="english">
            <select name="language" class="language" onchange="changeLan('{{ session()->get('content') ?? '' }}')" style="border:0px solid #ccc;background: #f2f2f2;">
                ...
                success: function (response) {
                   if(response.Status==0){
                       layer.msg(response.Message);
                        ...
                        window.location.href="{{url('reservation_code/add')}}"+"?id="+response.res['reservation_number_id']+"&content="+"<?php echo Request::session()->get('content','')?>";
                   }
