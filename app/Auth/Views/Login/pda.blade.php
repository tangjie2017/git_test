    ...
    <div class="pdalogin">
        <form action="#" class="layui-form" id="myForm">
            ...
            <div class="box">
                ...
                <input type="text"   name="userCode" maxlength="30" placeholder="{{ __('auth.userCode') }}" value="{{$userCode}}">
            </div>
            <div class="box"><img src="{{ asset('img/mm.png') }}" alt=""><input type="password"  name="password" maxlength="30" placeholder="{{ __('auth.password') }}" value="123456"></div>
